...
public static class NetworkGameState
{
    ...
    private static void PerformCleanupAndAdvance(GameStateSnapshot state)
    {
        ...
        current.Actions = 1; current.Buys = 1; current.Coins = 0; CostRules.ResetForTurn(current);
        ...
        nextPlayer.Actions = 1; nextPlayer.Buys = 1; nextPlayer.Coins = 0; CostRules.ResetForTurn(nextPlayer);
    }
